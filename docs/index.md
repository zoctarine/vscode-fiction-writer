...
!!! danger "Important!"
    This extension is in early development(concept) phase. Use only for testing purposes.

## Main Features

- [Enhanced text editing](features.md#text-editing):
...
- [Format document](features.md#formatting)
...
- [Export/Combine files](features.md#exporting)
...
- [Analyze text](features.md#text-analysis)
    - count words, phrases, word repetitions
    - view document statistics
    - ...

- [View](features.md#view)
    - fold paragraph lines
    - tag files (view badges in file explorer)
