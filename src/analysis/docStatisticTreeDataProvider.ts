  ...
  getChildren(element?: WordStatTreeItem): Thenable<WordStatTreeItem[]> {
    ...
    if (element) {
      ...
      return Promise.resolve([
        ...
        new WordStatTreeItem(
          asString(charCountNoSpaces),
          'Characters (exluding spaces)',
          3,
        ...
        new WordStatTreeItem(
          ...
          2,
          'Characters including spaces',
          new vscode.ThemeIcon('whitespace')
        ),
        new WordStatTreeItem(
          asString(estPages),
          'Est. Pages',
          4,
          'At 24 lines per page',
        ...
        new WordStatTreeItem(
          ...
          'Est. Lines',
          4,
          'At 10 words per line',
          new vscode.ThemeIcon('word-wrap')
        ),
        new WordStatTreeItem(
          asString(estWordCount),
          'Est. Word Count',
          4,
          'At 6 characters per word',
          new vscode.ThemeIcon('zap')
        ),
        new WordStatTreeItem(
          `${estReadTimeMin} min, ${estReadTimeSec} sec`,
          'Est. Reading Time',
          4,
          'At 200 wpm',
