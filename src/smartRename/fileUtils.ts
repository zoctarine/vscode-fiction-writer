import * as path from 'path';
 ...
 /**
   ...
   */
  export function getFileTree<T>(paths: string[], factory:(name:string, path:string, children:T[]) => T): T[]{
   ...
   * @returns IFile[]
   */
  export function getHierarchy<T>(fragments: string[][], history: string[], factory:(name:string, path:string, children:T[]) => T): T[] {
